...
export default function Login() {
  ...
  const [onlineuser, getOnlineUser] = useState([]);
  const onLogin = async (e) => {
    ...
    if (user) {
      const onlineuser = await getOnlineUser(req)
      if (onlineuser) {
        setisonline(true)
      } else navigate("/chat");
        ...
        {/* <form action="index.php?page=admin&controller=login&action=check" method="POST"> */}
          ...
          {isonline &&
            <div class="alert alert-danger d-flex align-items-center" role="alert">
              ...
              <div>
                Fail to login. This account is loginning somewhere.
              </div>
            </div>}
          {isonline || <></>}
          ...
          {incorect &&
            <div class="alert alert-danger d-flex align-items-center" role="alert">
              ...
              <div>
                Fail to login. Please enter the infomation correctly.
              </div>
            </div>}
          {incorect || <></>}
